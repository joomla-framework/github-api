...
class GistsTest extends GitHubTestCase
{
    ...
    public function testCreate()
    {
        ...
        $data = json_encode(
            [
                'files' => [
                    'file2.txt' => ['content' => 'This is the second file'],
                ],
                'public'      => true,
    ...
    public function testCreateGistFromFile()
    {
        ...
        $data = json_encode(
            [
                'files' => [
                    'gittest' => ['content' => 'GistContent' . PHP_EOL],
                ],
                'public'      => true,
                'description' => 'This is a gist',
            ]
    ...
    public function testCreateFailure()
    {
        ...
        // Build the request data.
        $data = json_encode(
            ['files' => [], 'public' => true, 'description' => 'This is a gist']
        );
    ...
    public function testEdit()
    {
        ...
        $data = json_encode(
            [
                ...
                'public'      => true,
                'files'       => [
                    'file1.txt' => ['content' => 'This is the first file'],
                    'file2.txt' => ['content' => 'This is the second file'],
                ],
            ]
        );
