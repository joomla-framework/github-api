...
class Notifications extends AbstractPackage
{
	 ...
	 * @param   \DateTimeInterface  $since          Filters out any notifications updated before the given time. The time should be passed in
	 ...
	 * @since   1.0
	 */
	public function getList($all = true, $participating = true, \DateTimeInterface $since = null)
	{
